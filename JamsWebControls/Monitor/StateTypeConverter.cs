...
{
    /// <summary>
    /// Converts StateType to and from a string value.
    /// </summary>
    internal class StateTypeConverter : StringConverter
    {
        /// <summary>
        ...
        {           
            return new StandardValuesCollection(Enum.GetNames(typeof(StateType)));
        }
